...
const auctionHouseAddresses: { [key: number]: string } = {
  1: mainnetAddresses.auctionHouse,
  4: rinkebyAddresses.auctionHouse,
  137: polygonAddresses.auctionHouse,
  80001: polygonMumbaiAddresses.auctionHouse,
};
...
export class AuctionHouse {
  ...
  constructor(signerOrProvider: Signer | Provider, chainId: number) {
    ...
    const address = auctionHouseAddresses[chainId];
    this.auctionHouse = AuctionHouse__factory.connect(
      address,
      signerOrProvider
    );
  }
